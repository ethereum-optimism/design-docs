...
| ETH Compatibility | Bridgeable as an ERC20, but unlikely to be interoperable. | Bridgeable as an ERC20 and potentially interoperable, as the WETH predeploy is preserved. |
...
| Easy of Deployment | Choose a L1 Token and deploy the chain as usual. | Deploy the chain as usual, and chain governors must deploy the relevant contracts to manage the native asset. |
