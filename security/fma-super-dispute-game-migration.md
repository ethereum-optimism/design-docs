# SuperDisputeGame Migration: Failure Modes and Recovery Path Analysis
...
This document covers the migration from single-chain dispute games (FaultDisputeGame/PermissionedDisputeGame) to SuperDisputeGame as a prerequisite for interop.

Below are references for this project:

- [Design Doc: SuperDisputeGame Migration](../protocol/proofs/super-dispute-game-migration.md)
